...
contract NFTAuction is Management {
    ...
    function getTokenIdOfAuction(uint256 _at)
        external
        view
        validIndex(_at)
        returns (uint256)
    ...
    function getSellerOfAuction(uint256 _at)
        external
        view
        validIndex(_at)
        returns (address)
    ...
    /// @param _at The index of the auction
    /// @return Seller address
    function getLastBuyerOfAuction(uint256 _at)
        external
        view
        validIndex(_at)
        returns (address)
    ...
    function getStopTimeOfAuction(uint256 _at)
        external
        view
        validIndex(_at)
        returns (uint256)
    ...
    function getCurrentPriceOfAuction(uint256 _at)
        external
        view
        validIndex(_at)
        returns (uint256)
    ...
    function getCurrentFeesToPayOfAuction(uint256 _at)
        external
        view
        validIndex(_at)
        returns (uint256)
    ...
    function getStatusOfAuction(uint256 _at)
        external
        view
        validIndex(_at)
        returns (uint256)
